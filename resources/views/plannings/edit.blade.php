        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="/plannings/{{$planning->id }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                >
                                    ...
                                    @foreach ($agents as $agent)
                                        <option
                                            value="{{ $agent->id }}"
                                            {{ old('agent_id', $planning->agent_id) == $agent->id ? 'selected' : '' }}
                                        >
                                            {{ $agent->nom }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-md-12">
                                ...
                                >
                                    ...
                                    @foreach ($sites as $site)
                                        <option
                                            value="{{ $site->id }}"
                                            {{ old('site_id', $planning->site_id) == $site->id ? 'selected' : '' }}
                                        >
                                            {{ $site->nom }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('heure_debut', $planning->heure_debut) }}"
                                    required
                                >
                                @error('heure_debut')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('heure_fin', $planning->heure_fin) }}"
                                    required
                                >
                                @error('heure_fin')
                                    <div class="invalid-feedback">{{ $message }}</div>
